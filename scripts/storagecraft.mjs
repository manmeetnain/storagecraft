...
try { if(command==='raid') raid(); else if(command==='erasure') erasure(); else if(command==='write-path') writePath(); else if(command==='lsm') lsm(); else if(command==='gpu-plan') gpuPlan(); else if(command==='rag-size') ragSize(); else if(command==='ai-path') aiPath(); else if(command==='nvme-queues') nvmeQueues(); else if(command==='kv') kv(); else if(command==='topics') topics(); else if(command==='doctor') await doctor(); else help(); }
